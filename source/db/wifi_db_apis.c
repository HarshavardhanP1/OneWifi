...
#define ONEWIFI_DB_VERSION_STATS_FLAG 100034
    ...
    rdk_wifi_vap_info_t *rdk_config)
{
    ...
    if (isVapSTAMesh(l_vap_index)) {
        ...
        wifi_util_dbg_print(WIFI_DB,
            ...
            "network_initiated_greylist=%d exists=%d hostap_mgt_frame_ctrl=%d mbo_enabled=%d interop_ctrl=%d inum_sta=%d\n",
            __func__, __LINE__, cfg.radio_name, cfg.vap_name, cfg.ssid, cfg.enabled,
            ...
            cfg.exists, cfg.hostap_mgt_frame_ctrl, cfg.mbo_enabled, cfg.interop_ctrl, cfg.inum_sta);
    }
...
int wifidb_update_wifi_global_config(wifi_global_param_t *config)
{
    ...
    cfg.num_stats = config->num_stats;
    cfg.marker_enable = config->marker_enable;
#ifndef NEWPLATFORM_PORT
    wifidml_desc_t *p_desc = &get_wifidml_obj()->desc;
